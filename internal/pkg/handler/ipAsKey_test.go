...
func TestIP(t *testing.T) {
	...
	str := ipSaverMock.VerifyWasCalledOnce().Save(pegomock.Any[string]()).GetCapturedArguments()
...
func TestIP_Fail(t *testing.T) {
	initIPTest(t)
	pegomock.When(ipSaverMock.Save(pegomock.Any[string]())).ThenReturn(errors.New("olia"))
